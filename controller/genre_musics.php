...
$musics=$db->query("SELECT *,musics.id AS music_id,artists.id AS artist_id,artists.image AS artist_image,musics.image AS music_image,
       artists.name AS artist_name,musics.name AS music_name,musics.artist_id AS music_artist_id
FROM musics 
    INNER JOIN artists ON musics.artist_id=artists.id WHERE musics.genre_id=$genre_id");
