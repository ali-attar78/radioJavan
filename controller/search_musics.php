...
$search_Musics=$_POST["searchText"];
...
FROM musics INNER JOIN artists ON musics.artist_id=artists.id WHERE musics.name LIKE '%$search_Musics%'");
...
require  "view/search_musics.php";
