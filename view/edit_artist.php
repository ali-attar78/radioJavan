                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-8" >
                    <div class="card  text-light card_add card_login" >
                        <div class="card-body p-5 text-center">
                            ...
                            <form method="post" action="edit_artist_process.php" enctype="multipart/form-data">
                                <h2 class="mb-5 mt-5">Edit Artist</h2>
                                <!-- Email input -->

                                <div class="input-container mb-5">
                                    <input type="text" name="name" required="" value="<?php echo $artist["name"]; ?>"/>
                                    <label>Name</label>
                                </div>
                                ...
                                <input type="hidden" name="artist_id" value="<?php echo $artist_id?>" class="form-control" />
