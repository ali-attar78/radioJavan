...
<div class="container ">
    <h2 class="text-light mt-3" >result of <?php echo $search_Musics?> </h2>
    <hr class="text-light">
</div>
...
<?php if($musics->num_rows==0):?>
    <div class="alert alert-dark " role="alert" style="text-align: center">
        <b>There are currently no music with this name</b>
    </div>
<?php else:?>
    <div class="row " dir="rtl">
        ...
        <div class="col-12 col-sm-7 col-lg-8 d-block justify-content-center " style="text-align: center" >
            ...
            <h3 class="text-light mt-3" id="albumName">Musics with the name <?php echo $search_Musics?></h3>
